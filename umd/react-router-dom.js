(function (global, factory) {
  ...
  */
  ...
  var _excluded$2 = ["innerRef", "navigate", "onClick"],
  ...
  var Link = forwardRef(function (_ref2, forwardedRef) {
    ...
    return /*#__PURE__*/React__default.createElement(context.Consumer, null, function (context) {
      ...
      // if the component renders, we don't need the prefix again. It's a one time application.
      var prefixedTo = to.startsWith(prefix) ? to : prefix + to;
      var location = normalizeToLocation(resolveToLocation(prefixedTo, context.location), context.location);
      var href = location ? history.createHref(location) : "";
      var props = _extends({}, rest, {
        href: href,
        navigate: function navigate() {
          var location = resolveToLocation(prefixedTo, context.location);
  ...
  var _excluded$3 = ["aria-current", "activeClassName", "activeStyle", "className", "exact", "isActive", "location", "sensitive", "strict", "style", "to", "innerRef"];
